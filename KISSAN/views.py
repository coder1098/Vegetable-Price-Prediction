...
def result(request) :
    ...
    prod_id = {'Onion': 1110, 'Tomato': 996, 'Potato': 1150, 'Sugercane': 1120, 'Brinjal': 1011, 'Okra': 1071}
    dict1 = {'prod_id':[prod_id[crop_name]],'Day':[day],'Month':[month],'Year':[year]}
    ...
    for i in range(0,6) :
        if (month != 12) :
            dict2 = {'prod_id':[prod_id[crop_name]],'Day':[day],'Month':[month+i],'Year':[year]}
        else :
            month = 1
            dict2 = {'prod_id':[prod_id[crop_name]],'Day':[day],'Month':[month],'Year':[year+1]}
    ...
    for i in range(0,6) :
        if (month != 12) :
            dict3 = {'prod_id':[prod_id[crop_name]],'Day':[day],'Month':[month+i],'Year':[year]}
        else :
            month = 1
            dict3 = {'prod_id':[prod_id[crop_name]],'Day':[day],'Month':[month],'Year':[year+1]}
